...
public class DeathPointManager {
    ...
    public static boolean isFavorite() {
        ...
        ModConfig.DeathPointData dp = ModConfig.getInstance().getDeathPoint(worldKey);
        return dp != null && dp.favorite;
    }
    ...
    public static void syncWaypoint(Minecraft client) {
        ...
        if (dp != null && dp.enabled && currentDim.equals(dp.dimension)) {
